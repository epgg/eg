...
if(tk.ft == FT_callingcard_n || tk.ft == FT_callingcard_c) {
	...
	return qtrack_getthreshold_cc(data2, tk.qtc, this.dspBoundary.vstartr, this.dspBoundary.vstopr, this.dspBoundary.vstarts, this.dspBoundary.vstops);
}
if(isNumerical(tk)) {
...
function qtrack_getthreshold_cc(data, qtconfig, startRidx, stopRidx, startDidx, stopDidx)
{
/* figure out threshold for a quantitative track for plotting
compute for positive/negative data separately
if not using threshold, use max value
...
if(tk.ft==FT_callingcard_c || tk.ft==FT_callingcard_n) {
	var countstr = '<div style="font-size:130%;padding-bottom:10px;">';
	if (result == null) {
		countstr += 'No data'
	} else {
